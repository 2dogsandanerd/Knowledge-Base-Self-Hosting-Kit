...
class QueryRequest(BaseModel):
    ...
    collections: Optional[List[str]] = Field(default=None, description="List of collections to query")
    collection: Optional[str] = Field(default=None, description="Single collection to query (alternative to collections)")
