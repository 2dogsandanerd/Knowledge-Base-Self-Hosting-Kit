...
async def create_collection(
    ...
    embedding_model: str = Form("nomic-embed-text:latest"),
    rag_client=Depends(get_rag_client),
    current_user: User = Depends(get_current_user)
):
    ...
    # Community Edition: No collection limits
    # Professional/Enterprise editions would check limits here with license validation
